...
function Testimonials({ data }) {
  ...
  return (
    <div className=" pb-20 lg:pb-30">
      <div className="max-w-245 mx-auto  flex flex-col items-center px-2.5 ">
        <h2 className="text-center text-neutral-950">{data?.headline}</h2>
        <p className="text-neutral-700 text-center text-[14px] lg:text-[18px] font-normal mt-4">
          {data?.description}
        </p>
      </div>
      <Container>
        <div className="mt-12.5 lg:mt-20">
          <Swiper
            slidesPerView={1.2}
            spaceBetween={20}
            pagination={{
