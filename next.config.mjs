  ...
  async redirects() {
    return [
      ...
      },
      {
        ...
        destination:
          "/blog/optimizing-google-business-profile-for-escape-rooms",
        permanent: true,
      },
      {
      ...
      {
        source:
          "/key-seo-metrics-every-escape-room-owner-should-analyze-and-track",
        destination:
          "/blog/key-seo-metrics-every-escape-room-owner-should-analyze-and-track",
        permanent: true,
      },
      {
      ...
      },
      {
        ...
        destination:
          "/blog/advanced-link-building-techniques-for-escape-room-website",
        permanent: true,
      },
      {
